...
**Tests**: Unit test tasks are MANDATORY per the project constitution (Principle I). Every feature
and fix MUST include unit test tasks covering new or corrected behavior. Tests MUST be written
